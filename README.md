...
- --bot-like-regexps -n comma separated list of regexps that identify a bot-like commit, commits that modify only files matching these will be flagged as bot-like
...
```
curl 'http://gerrit.mycompany.com/projects/myproject/analytics~contributors?bot-like-regexps=.%2B%5C.xml%2C.%2B%5C.bzl%2CBUILD%2CWORKSPACE%2C%5C.gitignore%2Cplugins%2F%2C%5C.settings'
